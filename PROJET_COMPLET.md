# 🎯 le p'tit bout de bois - Projet complet
...
| Aspect | le p'tit bout de bois | La p'tite perlouze |
|--------|----------------------|-------------------|
...
### Sites
- 🪵 le p'tit bout de bois : http://localhost:3001 (dev)
...
Le site **le p'tit bout de bois** est maintenant complet et prêt à l'emploi !
